...
clear
printf "
 _______ _______ _______  _____  _     _ _____ _______ _     _ _______  ______
 |       |_____| |  |  | |_____] |_____|   |   |______ |_____| |______ |_____/
 |_____  |     | |  |  | |       |     | __|__ ______| |     | |______ |    \_

"
printf "Created by Team KAEZAL"
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Choose a template:' option_tem
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Choose a Port Forwarding option:' option_server
